...
export function LockButton(): React.JSX.Element | null {
    ...
    return (
        <div className="sidebar-account">
            ...
            {/*
             * The grace period is behind the mark, not printed beside the button.
             *
             * It has to be *available* — „gesperrt" that quietly holds the key for half an hour
             * would be a lie about how locked locked is — but it is two lines of explanation next
             * to a control somebody uses on the way out of the room.
             */}
            <Info label="Was beim Abmelden passiert">
